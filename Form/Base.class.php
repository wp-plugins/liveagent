...
abstract class liveagent_Form_Base extends liveagent_Base {
	...
	protected function getNoAccountMessage() {
		return __('No account selected. Enter your existing account credetials, or create new <a href="#" onclick="onSignupRestart()">trial account</a>. (No credit card required)', LIVEAGENT_PLUGIN_NAME);
	}
