...
class liveagent_Form_Settings_Account extends liveagent_Form_Base {
    ...
    protected function initForm() {
        ...
        $this->addHtml('resetAccount', __('Cancel account', LIVEAGENT_PLUGIN_NAME));
        $this->addHtml('resetDescription', __('this will clear all your existing account settings and offer you to create a new free account',LIVEAGENT_PLUGIN_NAME));
    }
}
